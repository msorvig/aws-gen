//! Minimal MD5 (RFC 1321), self-contained like `base64`.
//!
//! Used only for the `Content-MD5` request header some S3 operations
//! require (e.g. DeleteObjects) — an integrity check, not a security
//! boundary; transport integrity comes from TLS + SigV4.
